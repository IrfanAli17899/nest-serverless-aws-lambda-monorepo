...
export const some = {
  isTruthy: (object: AnyObjectOrArray): boolean =>
    Object.values(object).some((v) => v),
  isFalsy: (object: AnyObjectOrArray): boolean =>
    Object.values(object).some((v) => !v),
  isUndefined: (object: AnyObjectOrArray): boolean =>
    Object.values(object).some((v) => v === undefined),
  isNullish: (object: AnyObjectOrArray): boolean =>
    Object.values(object).some((v) => v == null),
};

export const every = {
  isTruthy: (object: AnyObjectOrArray): boolean =>
    Object.values(object).every((v) => v),
  isFalsy: (object: AnyObjectOrArray): boolean =>
    Object.values(object).every((v) => !v),
  isUndefined: (object: AnyObjectOrArray): boolean =>
    Object.values(object).every((v) => v === undefined),
  isNullish: (object: AnyObjectOrArray): boolean =>
    Object.values(object).every((v) => v == null),
};

export const hasLength = (array: AnyArray): boolean => !!array?.length;
export const isEmpty = (object: AnyObjectOrArray): boolean =>
  !(object && Object.keys(object).length);

export const reconstruct = <
  T extends AnyObject,
  F extends MapFunc<Entry<T>, [string, unknown]>,
>(
  object: T,
  func: F,
  ...
  return Object.fromEntries(
    Object.entries(object).map(
      func as MapFunc<[string, unknown], [string, unknown]>,
    ),
...
export const invert = <T extends Record<string, string[]>>(
  ...
  return Object.fromEntries(
    Object.entries(obj).flatMap(([key, values]) =>
      [values].flat().map((value) => [value, key]),
    ),
  ) as Record<string, Key<T>>;
};

export const mapToProp = <T, P extends keyof T>(
  objArr: T[],
  prop: P,
): T[P][] => {
